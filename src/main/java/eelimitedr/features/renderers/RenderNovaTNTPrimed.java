package eelimitedr.features.renderers;
...
public class RenderNovaTNTPrimed extends Render
{
	private RenderBlocks blockRenderer = new RenderBlocks();

    public RenderNovaTNTPrimed()
    {
     ...
     */
    public void doRender(EntityNovaPrimed p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        GL11.glPushMatrix();
    ...
    {
        return this.getEntityTexture((EntityNovaPrimed)p_110775_1_);
    }
    ...
    {
        this.doRender((EntityNovaPrimed)p_76986_1_, p_76986_2_, p_76986_4_ + 0.5, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}
