...
public class BlockNovaTNT extends BlockEE implements UnlocalizedRegistry
{
    ...
    {
		top = reg.registerIcon("eelimitedr:novatnt/top");
		bottom = reg.registerIcon("eelimitedr:novatnt/bottom");
		side = reg.registerIcon("eelimitedr:novatnt/side");
    }
	@Override
	@SideOnly(Side.CLIENT)
