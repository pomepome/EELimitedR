...
public class EntityMobRandomizer extends EntityThrowable
{
	...
	protected void onImpact(MovingObjectPosition mop)
	{
		...
		Entity randomized = WorldUtils.getRandomEntity(this.worldObj, ent);

		if ((ent instanceof EntityLiving || ent instanceof EntityFireball)&& randomized != null && InventoryUtils.useResource(shooter, 16,true))
		{
			this.setDead();
			ent.setDead();
