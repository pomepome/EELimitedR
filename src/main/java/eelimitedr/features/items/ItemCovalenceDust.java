...
public class ItemCovalenceDust extends ItemEE implements UnlocalizedRegistry
{
    IIcon mid;
    IIcon high;
    ...
    {
        return par1ItemStack.getItemDamage() == 2 ? "item.CovalenceDust_high" : par1ItemStack.getItemDamage() == 1 ? "item.CovalenceDust_mid" : "item.CovalenceDust_low";
    }
