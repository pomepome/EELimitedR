...
{
	private static final ResourceLocation texture = new ResourceLocation("eelimitedr","textures/gui/aggregator.png");
	...
	protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_)
	{
        ...
        }
		{
			...
			int s = 14 - sunLevel;
    		this.drawTexturedModalRect(k + 56, l + s + 35, 176, s - 2, 14, sunLevel);
		}
