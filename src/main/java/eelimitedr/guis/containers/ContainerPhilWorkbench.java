...
import eelimitedr.guis.inventory.InventoryPhilWorkbench;
...
public class ContainerPhilWorkbench extends Container
{
	...
	public ContainerPhilWorkbench(InventoryPlayer invPlayer)
	{
		...
		craftMatrix = new InventoryPhilWorkbench(this, invPlayer.player.worldObj,invPlayer.player);
	...
	public void onContainerClosed(EntityPlayer player)
	{
		...
		if(EELimitedR.keepPhilInventory)
		{
			return;
		}
